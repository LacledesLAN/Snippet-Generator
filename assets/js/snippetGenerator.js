...
function Launch_CSGO_Tournament(bracketID, team1, team2, map, ip) {
    ...
    do {
        ...
        serverLaunchString += '--name ' + dockerContainerName + ' ';
        serverLaunchString += Docker.NetString_SRCDS(ip);
        serverLaunchString += '-v /home/sysoper/logs/gamesvr-csgo-tourney:/app/bin/csgo/logs ';
        serverLaunchString += '-v /home/sysoper/logs/gamesvr-csgo-tourney/warmod:/app/bin/csgo/addons/sourcemod/logs ';
