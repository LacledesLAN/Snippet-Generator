...
SRCDS.SVENCOOP.LaunchFreeplay = function (hostname, ip) {
    "use strict";
    ...
    UI.displayModal(
        "Sven Co-Op Freeplay",
        {
            "Launch String": UI.formatCommands('docker run -d ', dockerArgs, ['./svends_run ', srcdsArgs]),
